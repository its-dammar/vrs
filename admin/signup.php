			...
			<div class="d-flex flex-column align-content-end">
				<div class="app-auth-body mx-auto">
					...
					<div class="auth-form-container text-start mx-auto">
						...
						<form class="auth-form auth-signup-form" action="auth/register-process.php" method="POST" enctype="multipart/form-data">
							<div class=" mb-3">
								<label class="sr-only" for="signup-email">Your Name</label>
								<input id="signup-name" name="name" type="text" class="form-control" placeholder="Full name" required="required">
							</div>
							<div class=" mb-3">
								<label class="sr-only" for="signup-email">Username</label>
								<input id="signup-name" name="username" type="text" class="form-control" placeholder="Username" required="required">
							</div>
							<div class=" mb-3">
								<label class="sr-only" for="signup-email">Liscense No.</label>
								<input id="signup-name" name="liscence_no" type="text" class="form-control" placeholder="Liscense No." required="required">
							</div>
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto" name="register">Sign Up</button>
							</div>
						</form><!--//auth-form-->
